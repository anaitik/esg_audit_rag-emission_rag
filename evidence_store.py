...
def save_uploaded_file(uploaded_file, evidence_tag: str) -> str:
    """
    ...
    db.add_evidence_file(evidence_tag=safe_tag, file_path=path_str, original_name=uploaded_file.name)
